...
bibliography      : ["psy-references-results.bib", "r-references-results.bib"]
...
library(nlme)
library(kableExtra)
r_refs("r-references-results.bib")
```
