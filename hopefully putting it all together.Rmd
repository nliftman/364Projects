...
#//not quite sure why we are only combining the sexualor data, because we need
#//the ambivelent and hostile sexism stuff, but i think we can actually do
#//that after we figure out the pairwise data and just add it then
#//bc it will be the same for each dyad over time
