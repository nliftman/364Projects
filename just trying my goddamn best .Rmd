...
percent <- total_chores %>%
  ...
  summarize(daily_per = ifelse(cup_chores != 0, ind_chores / cup_chores, 999)) 
...
fixed_dyad <- fixed %>% 
  mutate(gender = ifelse(gender.x == "Woman", "W", "M")) %>%
...
>>>>>>> 3d69515430606bfef458520f55c422fb1c27b9ee
