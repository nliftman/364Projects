...
\hypersetup{
  pdftitle={PLS PLS PLS WORK, making a table},
  pdfauthor={Naomi Liftman1},
  pdflang={en-EN},
...
\title{PLS PLS PLS WORK, making a table}
\author{Naomi Liftman\textsuperscript{1}}
\date{}
...
\hypertarget{table-time}{%
\section{TABLE TIME}\label{table-time}}
...
\hline
Time & >-0.01 & -0.05 & 0.96 & -0.01 & -2.39 & 0.02\\
\hline
Partner's Percent of Chores & 1.43 & 0.76 & 0.45 & -1.01 & -0.45 & 0.65\\
\hline
Actor's Perrcent of Chores & 1.86 & 0.97 & 0.33 & -1.51 & -0.69 & 0.49\\
\hline
Actor's Hostile Sexism & -0.08 & -0.44 & 0.66 & 0.05 & 0.24 & 0.81\\
\hline
\end{tabular}
\end{table}
