...
tab <- matrix(nrow = 4, ncol=6, byrow=TRUE)
colnames(tab) <- c('Men M  (SD)', 'Women  M (SD)', '1','2', '3', '4')
rownames(tab) <- c('1. Hostile sexism', '2. Benevolent sexism', '3. Division of household labor', '4. Feelings of being a team')
